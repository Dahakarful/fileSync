...
sio.on('connection', function(socket) {
  ...
  socket.on('chat:message:new', function(message){
    ...
    console.log('chat:message:new', socket.nickname, message, createdAt);
    sio.emit('chat:message:new', socket.nickname, message, createdAt);
  });

  /*socket.on('mirror:mousemove:change', function(x, y){
    console.log('mirror:mousemove:change', socket.nickname, x, y);
    sio.emit('mirror:mousemove:change', socket.nickname, x, y);
  });*/
